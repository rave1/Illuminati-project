        ...
        <div className='h-screen flex items-center justify-center'>
           <div className='bg-white w-[1200px] py-8  mx-auto- flex justify-center drop-shadow-2xl rounded-md'>
            <table className="rounded-md bg-white text-black drop-shadow-lg overflow-hidden">
              <tbody>
                <tr className=''>
                  <th className='py-3 px-4 text-center bg-amber-100 border w-auto'>
                  ...
                  <th className='py-3 px-4 text-center'>
                    <span className='text-black text-md'>Coffee 27th Street, Suite 527, New York</span>
                  </th>
                </tr>
                <tr className=''>
                  <th className='py-3 px-4 text-center bg-amber-100 border w-auto'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
                        <path d="M21 12C21 10.1195 20.411 8.28625 19.3156 6.7577C18.2203 5.22915 16.6736 4.08209 14.893 3.47763C13.1123 2.87316 11.187 2.84166 9.38744 3.38754C7.58792 3.93341 6.00459 5.02925 4.85982 6.52115C3.71505 8.01304 3.06635 9.82604 3.00482 11.7055C2.94329 13.585 3.47203 15.4366 4.51677 17.0001C5.56152 18.5637 7.06979 19.7608 8.82975 20.4232C10.5897 21.0856 12.513 21.18 14.3294 20.6933" stroke="#33363F" strokeWidth="2" strokeLinecap="round"/>
                        <circle cx="12" cy="12" r="4" stroke="#33363F" strokeWidth="2"/>
                        <path d="M16 9V13.5C16 14.8807 17.1193 16 18.5 16V16C19.8807 16 21 14.8807 21 13.5V12" stroke="#33363F" strokeWidth="2" strokeLinecap="round"/>
                    </svg>
                  </th>
                  <th className='py-3 px-4 text-center'>
                    <span className='text-black text-md'>illuminati@illuminati.org</span>
                  </th>
                </tr>
                <tr className=''>
                  <th className='py-3 px-4 text-center bg-amber-100 border w-auto'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
                        <path d="M17.7071 13.7071L20.3552 16.3552C20.7113 16.7113 20.7113 17.2887 20.3552 17.6448C18.43 19.57 15.3821 19.7866 13.204 18.153L11.6286 16.9714C9.88504 15.6638 8.33622 14.115 7.02857 12.3714L5.84701 10.796C4.21341 8.61788 4.43001 5.56999 6.35523 3.64477C6.71133 3.28867 7.28867 3.28867 7.64477 3.64477L10.2929 6.29289C10.6834 6.68342 10.6834 7.31658 10.2929 7.70711L9.27175 8.72825C9.10946 8.89054 9.06923 9.13846 9.17187 9.34373C10.3585 11.7171 12.2829 13.6415 14.6563 14.8281C14.8615 14.9308 15.1095 14.8905 15.2717 14.7283L16.2929 13.7071C16.6834 13.3166 17.3166 13.3166 17.7071 13.7071Z" stroke="#33363F" strokeWidth="2"/>
                    </svg>
                  </th>
                  <th className='py-3 px-4 text-center'>
                    <span className='text-black text-md'>(21) 372 115 997</span>
                  </th>
                </tr>
              </tbody>
            </table>
